...
- [x] 3. Memory system
  - [x] 3.1 Implement `MemorySystem` with Redis short-term memory
  ...
  - [x] 3.2 Implement long-term vector memory with Pinecone
  ...
  - [x] 3.3 Write property test for memory namespacing
...
- [x] 4. Tool registry and built-in tools
  ...
  - [x] 4.3 Implement `WebScraperTool`
  ...
  - [x] 4.4 Implement `CalculatorTool`
  ...
  - [x] 4.5 Write property test for tool input/output schema compliance
  ...
  - [x] 4.6 Write unit tests for ToolRegistry
...
- [x] 5. Planner Agent
  - [x] 5.1 Implement prompt builders for Planner
  ...
  - [x] 5.2 Implement `validateAndNormalizePlan()`
  ...
  - [x] 5.3 Write property test for `validateAndNormalizePlan`
  ...
  - [x] 5.5 Write unit tests for PlannerAgent
